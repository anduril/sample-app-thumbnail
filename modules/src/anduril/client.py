...
from .environment import andurilEnvironment
...
class anduril:
    ...
    environment : andurilEnvironment
        The environment to use for requests from the client. from .environment import andurilEnvironment



        Defaults to andurilEnvironment.DEFAULT
    ...
    def __init__(
        ...
        *,
        ...
        environment: andurilEnvironment = andurilEnvironment.DEFAULT,
...
def _get_base_url(*, base_url: typing.Optional[str] = None, environment: andurilEnvironment) -> str:
